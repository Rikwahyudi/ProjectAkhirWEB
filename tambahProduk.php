...
<div class="panel-default">
    <div class="panel-heading">
        <div class="panel-body">
            <!--tambah produk-->
            <form class="" id="submitProductForm" action="">
                <div>
                    <h4><i class="fa fa-plus"></i> Tambah Produk</h4>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <button type="submit" class="btn btn-primary" data-loading-text="Mohon Menunggu"> <i
